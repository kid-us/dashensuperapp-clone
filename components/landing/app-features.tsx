  ...
  return (
    <div className="max-w-6xl mx-auto py-12 md:py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-0">
        ...
        <Link
          href={"/features"}
          className="flex text-primary font-medium text-sm items-center gap-1 border py-3 px-6 rounded-full hover:border-primary hover:bg-primary/5 hover:text-primary transition-all duration-300 group whitespace-nowrap"
        >
          See All Features{" "}
          <ArrowRight
            size={18}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 mt-10 gap-12 lg:gap-20 items-center">
        ...
        <div className="space-y-10 lg:space-y-20 w-full">
          ...
          >
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              ...
              fingertips. Every interaction is simplified so checking balances,
              paying bills, and moving money feels effortless and fits around
          ...
          >
            ...
            <h3 className="font-semibold text-lg text-slate-900">Budgeting</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
              Every transaction becomes an insight. Set spending limits, review
              your money flow, and track where every birr goes. Dashen Bank
              Super App gives you clear control over your finances so you can
              stay ahead of your spending and plan with confidence instead of
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 mt-12 lg:mt-20">
        ...
        >
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            Keep conversations and confirmations together in one secure thread.
            Share payment details, send receipts, and stay connected without
            leaving the app. Dashen Bank Super App makes banking chats feel as
            simple and natural as everyday messaging, so you always have the
        ...
        >
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            Browse partner stores, shop online, and pay securely—all from inside
            Dashen Bank Super App. No need to jump between apps or websites when
            you want to buy what you need. With integrated payments and the same
            security you trust for banking, your shopping experience stays
